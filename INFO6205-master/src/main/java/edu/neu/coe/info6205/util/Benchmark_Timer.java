...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    public static void SortRandom() {
    	...
    	for(int m = 0; m < 7; m ++) {
        	...
        	Benchmark_Timer f = new Benchmark_Timer<>("MeasureRuningTimes", t ->{s.sort(list);});
        	System.out.println("Random" + "\nn:" + n + "\ntime:" + f.run(list,500));
    	}
    }
    
    public static void SortOrdered() {
    	int n = 50;
    	for(int m = 0; m < 7; m ++) {
    		n = n * 2;
        	List<Integer> list = new ArrayList<>();
    ...
    public static void SortPartiallyOrdered() {
    	int n = 50;
    	for(int m = 0; m < 7; m ++) {
    		n = n * 2;
    		List<Integer> list = new ArrayList<>();
    ...
    public static void SortReverseOrdered() {
    	int n = 50;
    	for(int m = 0; m < 7; m ++) {
    		n = n * 2;
    		List<Integer> list = new ArrayList<>();
